...
- 在 Grade 旁顯示策略適配效率的改善／惡化趨勢；箭頭不是股價預測或直接買賣訊號。
...
目前 Grade、追高、承低、賣出、加碼與成交假設的組成、門檻及檢驗狀態，請參閱[現行回測規則](doc/現行回測規則.md)；回測方法、計畫、歷史實驗與已退出規則則見[回測規則驗證](doc/回測規則驗證.md)。
...
2. 近三年模擬的[實年報酬率](doc/報酬率.md#實年報酬率)與平均週期會合成效率分數；分數高於 46 的 `wow` 評等標示為紅星，旁邊的[趨勢箭頭](doc/選股評等.md#grade-趨勢圖示)補充近期適配效率正在改善或惡化。
...
沒有，目前也不再規劃上架 App Store。專案以開發測試及 Ad Hoc 方式分享，只能安裝在已登記的裝置。
