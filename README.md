...
介面以 13 吋 iPad 為主要設計基準，並已驗證約 10 吋 iPad 的橫式與直式版面。 放大系統文字後，空間不足的每日交易紀錄會改為兩列，並省略部分趨勢圖示；完整資訊仍可在技術檢視查看。

## 可以做什麼

- 搜尋上市股票並組成股群，自動補齊歷史行情。
- 透過 <img src="doc/icons/cleanup.png" alt="清理歷史資料" width="22" height="22"> 自行選擇是否[清理歷史資料](doc/歷史資料管理.md#為什麼提供清理功能)：保留可減少日後重新下載，清理則有助減少資料占用，無須定期清理。
...
- [真年報酬率警示](doc/真年報酬率警示.md)
- [報酬率](doc/報酬率.md)
- [週期與行情更新時間](doc/週期.md)
- [歷史資料清理與重新納入](doc/歷史資料管理.md)
