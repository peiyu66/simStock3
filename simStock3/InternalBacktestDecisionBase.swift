...
enum InternalBacktestDecisionRecorder {
    ...
    private static let ruleDescriptions: [String: String] = [
        ...
        "H-N09": "價格位置過高",
        "H-N10": "成交量創九日低點",
        "H-N13": "空手 wow 探頂前期且 K／J 的 125 日標準分都高於 1.8 時，H 減一分",
        ...
        "L-P08": "價格位於相對低檔",
        "L-P09": "良好評等股票強烈拉回",
        "L-P10": "恢復後 weak／fine，或持股 low、價格非盤整且前市場日九日最高，增加低接意願",
        "L-P11": "wow 評等在適配惡化反彈期增加低接意願",
        "L-P12": "空手且個股價格反彈後期，原 H 未成立後增加一票低買確認",
        "L-N01": "MA20 長期下彎",
        ...
        "S-P09": "個股價格探底前期時賣出加 1 分",
        "S-N01a": "MA60 創九日低點，先別在弱點賣",
        "S-N01b": "MA20 創九日低點，先別在弱點賣",
        "S-N01c": "前一市場日創九日低點，有效非 wow 且排除探頂後期 fine 以上；a/b 未扣分才惜賣",
        "S-N02": "高評等股票收盤大漲時惜賣",
        "S-N03": "一般評等股票盤中大漲時惜賣",
        "S-N04": "多次投入後惜賣",
        "S-N05": "良好評等股票放量時惜賣",
        ...
        "S-T02h": "長期中度虧損且效率分數偏低的獨立認賠資格",
        "A-P01a": "多項指標都低，鼓勵加碼",
        "A-P01b": "弱評股不必等多項都低，也保留加碼",
        "A-P02": "多項九日低點加分",
        "A-P03": "深度虧損加分",
        "A-P04": "價格位置加分",
        "A-P05": "均線深跌加分；exact wow 惡化預警／確認期間除外",
        "A-P06": "均線 Z 深跌加分",
        "A-P07": "兩均線下跌加分",
